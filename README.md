...
<div style="text-align: center;">
    ...
    <p><strong>Alumno:</strong> Diego Oliver Basilio</p>
...
class _CounterFunctionsScreenState extends State<CounterFunctionsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Center(child: Text('CFS-210436')),
        ),
        body: Center(
          child: Column(
...
```bash
import 'package:flutter/material.dart';
//import 'package:helloworld_app_210436/presentation/screens/counter_screen.dart';
import 'package:helloworld_app_210436/presentation/screens/counter_functions_screen.dart';
